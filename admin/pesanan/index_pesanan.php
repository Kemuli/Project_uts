...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../produk/index_produk.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Produk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../pesanan/index_pesanan.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pesanan</p>
                </a>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><a href="add_pesanan.php" style="background-color: white;
  color: black;
  ...
  color: white;">tanggal</th> <th style="background-color: #04AA6D;
  color: white;">nama</th> <th style="background-color: #04AA6D;
  color: white;">alamat</th> <th style="background-color: #04AA6D;
  color: white;">nomor</th> <th style="background-color: #04AA6D;
  color: white;">email</th> <th style="background-color: #04AA6D;
  color: white;">jumlah pesanan</th> <th style="background-color: #04AA6D;
  color: white;">Deskripsi</th> <th style="background-color: #04AA6D;
  color: white;">Produk</th>
    </tr>
    <?php  
